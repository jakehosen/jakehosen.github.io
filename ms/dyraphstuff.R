...
write.csv(farm_sonde2[,c("dt","Temp_deg_C","pH_units","SpCond_uS_cm","HDO_mg_l","fdom_qsu_temp","fdom_turb_ife","CDOM_qsu")],file="farm_sonde_dygraph.csv","X_00060_00011",row.names=FALSE)
